    ...
    case "tools/call": {
      ...
      if (name === "holo_build") {
        ...
        try { const b = await forgeApp().build(args.source, { lang: args.lang });
          return reply(text({ ok: true, kappa: b.kappa, sourceKappa: b.sourceKappa, receipt: b.receipt, exports: b.exports, rebind: !!b.hit })); }
