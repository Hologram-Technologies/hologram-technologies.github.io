...
/** @typedef {import('../../wallet/src/protocols/index.js').ISwapProtocol} ISwapProtocol */

/** @typedef {import('../../wallet/src/protocols/index.js').IBridgeProtocol} IBridgeProtocol */

/** @typedef {import('../../wallet/src/protocols/index.js').ILendingProtocol} ILendingProtocol */

/** @typedef {import('../../wallet/src/protocols/index.js').IFiatProtocol} IFiatProtocol */

/** @typedef {import('../../wallet/src/protocols/index.js').ISwidgeProtocol} ISwidgeProtocol */
