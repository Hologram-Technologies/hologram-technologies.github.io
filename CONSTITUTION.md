...
> content-addressed object — [`constitution.uor.json`](system/os/etc/constitution/constitution.uor.json) —
...
>
> **The living parts** — machine-readable law [`constitution.uor.json`](system/os/etc/constitution/constitution.uor.json) ·
> runtime gate [`holo-conscience.js`](system/os/usr/lib/holo/holo-conscience.js) ·
> consistency proof [`proof.json`](system/os/etc/constitution/proof.json) ·
> amendment chain [`amendments.uor.json`](system/os/etc/constitution/amendments.uor.json) ·
> agent door [`constitution.json`](system/os/.well-known/constitution.json) ·
> decision record [`ADR-033`](system/docs/adr/0033-holo-constitution.md).
